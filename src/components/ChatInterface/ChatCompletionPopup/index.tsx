// src/components/ChatCompletionPopup/index.tsx
...
export default function ChatCompletionPopup({ 
  language, 
  onClose 
}: ChatCompletionPopupProps) {
  ...
  return (
    <div 
      className="fixed inset-0 bg-black/75 flex items-center justify-center z-50 animate-fadeIn"
      ...
      <div className="bg-gray-800 rounded-2xl p-8 max-w-md w-full mx-4 shadow-2xl animate-scaleIn">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-300">
            Well done! You've successfully completed this conversation.
            Would you like to try chatting with another tutor?
          </p>
        </div>
        ...
        <div className="space-y-4">
          <button
            ...
            className="w-full bg-gradient-to-r from-blue-500 to-indigo-600 
              text-white py-3 px-8 rounded-lg text-lg font-medium 
